...
TEST(LoadBalancerSubsetInfoImplTest, KeysSubsetFallbackValid) {
  ...
  selector1->set_fallback_policy(envoy::api::v2::Cluster::LbSubsetConfig::LbSubsetSelector::KEYS_SUBSET);
  ...
  selector2->set_fallback_policy(envoy::api::v2::Cluster::LbSubsetConfig::LbSubsetSelector::KEYS_SUBSET);
